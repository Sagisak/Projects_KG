	...
	DECLARE @EndDt DATE = '2025-04-30'  --Ini kalau mau set manual tergantung periode yang dinginkan , contoh kode ini buat periode 1 January 2025
...
Select
Status, count(MyValueId) as total
from gettingStatus
group by Status