...
DeptsClassSubclassTotal AS (
  ...
  GROUP BY 
    MyValueId,
    CONCAT(DeptName, ' - ', ClassName, ' - ', SubClassName), GroupName
),
...
SELECT DISTINCT
  ...
  t.CustomerName,
  t.phone,
  rf.FullCategoryName AS 'FavoriteFullCategory (Department-Class-Subclass)',
