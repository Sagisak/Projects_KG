...
group by g.MyValueId, g.Phone, g.EmailAddress, g.gender, G.Profession, g.Status
HAVING SUM(t.price) > 0
order by g.Status asc, jumlah_transaksi DESC, net_sales DESC, g.MyValueId